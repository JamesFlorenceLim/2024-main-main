...
<div className="inline-block min-w-full overflow-x-auto relative">
    {/* PAGINATION */}
    <h1 className="ml-80 text-red-800">Drivers</h1>
    <nav className="pagination-top flex items-center -space-x-px ml-[700px] mt-[-1.5rem] mb-1" aria-label="Pagination">
          <button
            type="button"
  ...
  <table className="bg-white rounded-lg mx-auto  overflow-hidden" style={{ tableLayout: 'fixed', marginLeft: '16rem' }}>
